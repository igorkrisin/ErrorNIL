...
class UserHeaderCell: UICollectionReusableView {
    static var reuseId = "UserHeaderCell"
    ...
    lazy var headerBtn = UIComponents.createButton(titleText: "Показать всех", textColor: .appBlue, action: headerBtnAction)
    
    private lazy var headerBtnAction = UIAction { [weak self] action in
       print("Header BTN User taped")
